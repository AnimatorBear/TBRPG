            ...
            if (preset != 0)
            {
                switch (preset)
                {
                    ...
                    case 4:
                        ...
                        enemy.damage -= 13;
                        enemyBrain.SelectSprite(Enemy.sprites.Bandit);
                        currentPlayer.hasKey[3] = true;
                        break;
                    //other village guard but like inside
                    case 5:
                        enemy.currentClass = enemyBrain.ChooseClass();
                        enemy.RecalculateStats();
                        enemyBrain.isPreset = true;
...
{' ',' ',' ','b','b','b','b','h','h','h','h','h','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','e','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b',},
{' ',' ',' ',' ',' ',' ','b','h','h','h','h','h','b',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',' ','5',' ','b',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',},
{' ',' ',' ',' ',' ',' ','b','h','h','h','h','h','b',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b','b','b',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',},
{' ',' ',' ',' ',' ',' ','b','h','h','h','h','h','b',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b','r','o','k','e','n',':','(',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',},
{' ',' ',' ',' ',' ',' ','b','h','h','h','h','h','b',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',},
{' ',' ',' ',' ',' ',' ','b','h','h','h','h','h','b',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',},
{' ',' ',' ',' ',' ',' ','b','h','h','h','h','h','b',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',},
{' ',' ',' ',' ',' ',' ','b','h','h','h','h','h','b',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',},
...
{' ',' ',' ','b',' ',' ','b','l','l','l','l','l','b',' ',' ',' ',' ',' ','t',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',' ',' ',' ',' ',' ',' ','h','h','h','h','h','h','h','h','h',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','t',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',' ',' ','b',},
{' ',' ','b',' ',' ',' ',' ','3','3','3','3','3',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','t',' ',' ',' ',' ',' ',' ','b',' ',' ',' ',' ',' ','h','h','h','h','h','h','h','h','h','h','h',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',' ','b',},
{' ','b',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',' ',' ',' ',' ',' ','h','h','h','b','b','b','b','b','h','h','h',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','t',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b','b',' ',' ',' ',' ',' ',' ','b',' ','b',},
{'b',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',' ',' ',' ',' ',' ','h','h','h','b','d','d','d','b','h','h','h',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b','b','b','b',' ',' ',' ',' ',' ',' ',' ','b',' ',' ',' ',' ','b',' ',' ',' ',' ',' ','b',' ',' ','b',},
...
{' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','b',},
        ...
        static int[] playerLocation = { 33, 9 };
            ...
            switch (mapInVisible[playerLocation[0] + top, playerLocation[1] + left])
            {
                ...
                case 'k':
                    ...
                    try
                    {
                        ...
                        currentPlayer.hasKey[numb - 1] = true;
                    }
                    catch (FormatException)
                    {
                ...
                case 'l':
                    ...
                    try
                    {
                        ...
                        if (currentPlayer.hasKey[numb - 1])
                        {
                            return true;
                        }
                        else
        ...
        static void Dialoge(int dialoge)
        {
            ...
            {
                case 0:
                    text = new string[] { "You got healed", "", "" };
                    WriteDialoge(text);
                    break;
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    text = new string[] { "Bandit:", "Fight us for your key", "Press ENTER to continue" };
                    WriteDialoge(text);
                    key = Console.ReadKey(true).Key;
                    while (key != ConsoleKey.Enter)
                    {
                    ...
                    break;
                case 4:
                    text = new string[] { "This door needs a key", "Maybe check the forest for no reason at all", "Press ENTER to continue" };
                    if (!currentPlayer.hasKey[0])
                    {
                        WriteDialoge(text);
                        key = Console.ReadKey(true).Key;
                        while (key != ConsoleKey.Enter)
                    ...
                    break;
                case 5:
                    text = new string[] { "Guard:", "No getting in.", "Press ENTER to continue" };
                    WriteDialoge(text);
                    key = Console.ReadKey(true).Key;
                    while (key != ConsoleKey.Enter)
                    {
                    ...
                    break;
                case 6:
                    text = new string[] { "Evil guy:", "haha I take over your village", "Press ENTER to continue" };
                    WriteDialoge(text);
                    key = Console.ReadKey(true).Key;
                    while (key != ConsoleKey.Enter)
                    {
                    ...
                    text = new string[] { "Evil guy:", "Fight me or else", "Press ENTER to continue" };
                    WriteDialoge(text);
                    key = Console.ReadKey(true).Key;
                    while (key != ConsoleKey.Enter)
                    {
